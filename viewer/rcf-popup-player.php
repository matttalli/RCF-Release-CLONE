...
if(isset($_GET['runtimeLanguage'])) {
	$lang = $_GET['runtimeLanguage'];
}
...
?>
<!doctype html>
<html class="<?php if ($isMonoRepo) { echo "rcf-monorepo"; } ?>" lang="<?=$lang ? $lang : 'en'; ?>">

	<head>
		<title>RCF Pop-up Player</title>
...
<!-- LEVELS css -->
		...
		<style>
			...
			.playerToolbar .showAnswersLabel {
				display: flex;
				flex-direction: column;
				justify-content: center;
				align-items: center;
			...
			.rcf-monorepo .playerToolbar .gradableTypeContainer,
			.rcf-monorepo .playerToolbar .showAnswersLabel {
				color: #fff;
			}
			...
			.rcf-monorepo .playerToolbar button:focus {
    ...
    <body>
		...
		-->
		<div class="popupPlayer">
			<!-- announcer for the popup player to announce the score -->
			<div id="popup-player_ariaLive" aria-live="assertive" role="status" class="rcfPlayerAriaLive visually-hidden" tabindex="-1"></div>
			<div id="contentContainer" class="rcfContentContainer activityContent">
				<!--
