...
/* Gets a property from metadata.xml at a lesson level */

$app->get('/lesson/:level/:searchValue', function($level, $searchValue) use ($app) {
    ...
    foreach ($level_r as $sub_path) {
        ...
        if(stripos($sub_path, 'lesson_') !== false) {
